...
def shelves():
    ...
    if request.method == 'GET':
        ...
        if form.validate():
            ...
            form.name.data = ''
            return render_template('shelves.html', form=form, test_shelf_dict_=test_shelf_dict, shelf_added=True)
        else:
...
def bins():
    ...
    if request.method == 'GET':
        ...
        if form.validate():
            ...
            form.name.data = ''
            return render_template('bins.html', form=form, test_bin_dict_=test_shelf_dict, shelf_added=True)
        else:
